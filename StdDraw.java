 ...
 * <a href =
 * "https://introcs.cs.princeton.edu/java/code/stdlib.jar">stdlib.jar</a>
 ...
 * The size of a square or rectangle is specified by its half-width or
 * half-height.
 ...
 * {@code StdDraw.arc(0.0, 0.0, 1.0, 0, 90)}
 * draws the arc of the unit circle from 3 o'clock (0 degrees) to 12 o'clock (90
 * degrees).
 * <p>
 * <b>Polygons.</b>
 ...
 * Ordinarly, this method is called only once, at the very beginning of a
 * program.
 ...
 * directly, without needing the fully qualified name
 ...
 * The image will display at its native size, independent of the coordinate
 * system.
 * Optionally, you can rotate the image a specified number of degrees
 * counterclockwise
 ...
 * the onscreen canvas, where it is displayed in the standard drawing window.
 * You
 ...
 * It is much less powerful than most user interface libraries provide, but also
 * much simpler.
 ...
 * the mouse's
 * current position, using the same coordinate system as the canvas (the unit
 * square, by default).
 * You should use these methods in an animation loop that waits a short while
 * before trying
 ...
 * process them.
 * The first method tells you whether the user has typed a key (that your
 * program has
 * not yet processed).
 * The second method returns the next key that the user typed (that your program
 * has
...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
     ...
     *                                  or {@code blue} is outside its prescribed
     *                                  range
     */
     ...
     * already processed).
     * This method should be preceded by a call to {@link #hasNextKeyTyped()} to
     * ensure
